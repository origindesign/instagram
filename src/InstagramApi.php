<?php
/**
 * @file Contains \Drupal\instagram\InstagramApi
 */

namespace Drupal\instagram;


use Drupal\instagram\InstagramException;
 ...
 * @since 30.10.2011
 * @copyright Christian Metz - Drupal Networks 2011-2014
 * @version 2.2
...
class InstagramApi{
     ...
     * @return void
     *
     * @throws \Drupal\instagram\InstagramException
     */
    ...
    public function getUserMedia($id = 'self', $limit = 0, $min_id = null, $max_id = null)
    {
        ...
        $result = $this->_makeCall('users/' . $id . '/media/recent', $params);
    ...
    public function getTagMedia($name, $limit = 0, $min_tag_id = null, $max_tag_id = null)
    {
        ...
        $result = $this->_makeCall('tags/' . $name . '/media/recent', $params);
